...
public class ChallengeEditActivity extends AppCompatActivity implements Spinner.OnItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recviewimg.setLayoutManager(new GridLayoutManager(ChallengeEditActivity.this, 3));
        challengeImageAdapter = new ChallengeImageAdapter(imagearrbitmap, ChallengeEditActivity.this);
        ...
        challengeFor_textInputLayout.setAdapter(new ArrayAdapter<String>(ChallengeEditActivity.this, android.R.layout.simple_spinner_dropdown_item, getResources().getStringArray(R.array.challengefor)));
...
//                recviewimg.getAdapter().notifyDataSetChanged();
            ...
            for (int i = 0; i < getResources().getStringArray(R.array.challengefor).length; i++) {
                if (getResources().getStringArray(R.array.challengefor)[i].equalsIgnoreCase(pojo.getChallangesfor())) {


                    Log.d("fdfsdfdfsdf", String.valueOf(i));
                    challengeFor_textInputLayout.setSelected(true);
                    challengeFor_textInputLayout.setSelection(i);
        ...
        postChallengeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!validation.edttxtvalidation(challengeName_textInputLayout, ChallengeEditActivity.this)) {

                } else if (!validation.edttxtvalidation(challengeDesc_textInputLayout, ChallengeEditActivity.this)) {

                } else if (!validation.edttxtvalidation(challengeLocation_textInputLayout, ChallengeEditActivity.this)) {

                } else if (!validation.edttxtvalidation(challengeDate_textInputLayout, ChallengeEditActivity.this)) {

                } else if (imagearrbitmap.size() < 2) {
                    //imagearr
                    Toast.makeText(ChallengeEditActivity.this, "Please select atleast two images", Toast.LENGTH_SHORT).show();
                } else if (publishradioButton == null) {
                    Toast.makeText(ChallengeEditActivity.this, "Please select publish to", Toast.LENGTH_SHORT).show();
                } else if (challengeFor_textInputLayout.getSelectedItem().equals("What you offer for challenge winner?")) {
                    Toast.makeText(ChallengeEditActivity.this, "Please select challenge for", Toast.LENGTH_SHORT).show();
                } else {
                    pd.show();
                    ...
                    VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, WebUrl.Update_challenge,
                                    ...
                                    try {
                                        ...
                                        if (jsonObject.getString("status").equals("1")) {
                                           // finish();
                                            ...
                                            Intent intent=new Intent(ChallengeEditActivity.this, ChallangeaddedbymeActivity.class);
                        ...
                        public void onErrorResponse(VolleyError volleyError) {
                            ...
                            if (message != null) {
                                ...
                                Toast.makeText(ChallengeEditActivity.this, message, Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(ChallengeEditActivity.this, getResources().getString(R.string.anerroroccured), Toast.LENGTH_SHORT).show();
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            param.put("user_id", PrefManager.getUserId(ChallengeEditActivity.this));
                            param.put("challenge_type", "1");  //typeforchallenge
                    ...
                    MySingleton.getInstance(ChallengeEditActivity.this).addToRequestQueue(volleyMultipartRequest);
                }
        ...
        challengeLocation_textInputLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Autocomplete.IntentBuilder(
                        ...
                        .build(ChallengeEditActivity.this);
        ...
        addpicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(ChallengeEditActivity.this, WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {

                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (validation.neverAskAgainSelected(ChallengeEditActivity.this, WRITE_EXTERNAL_STORAGE, "STORAGE")) {
                            validation.displayNeverAskAgainDialog("storage", ChallengeEditActivity.this);
                        } else {
                            ActivityCompat.requestPermissions(ChallengeEditActivity.this,
        ...
        challengeDate_textInputLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dp = new DatePickerDialog(ChallengeEditActivity.this, android.R.style.Theme_Holo_Light_Dialog, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {


                        TimePickerDialog tp = new TimePickerDialog(ChallengeEditActivity.this, android.R.style.Theme_Holo_Light_Dialog, new TimePickerDialog.OnTimeSetListener() {
    ...
    private void delimgfrmdb(String imgidstr, int position) {
        ...
        stringRequest.setRetryPolicy(new DefaultRetryPolicy(
                ...
                DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        MySingleton.getInstance(ChallengeEditActivity.this).addToRequestQueue(stringRequest);
            ...
            case 2:
                ...
                if (PResult.length > 0 && PResult[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                        ...
                        if (photoFile != null) {
                            Uri photoURI = FileProvider.getUriForFile(ChallengeEditActivity.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_PICK && resultCode == RESULT_OK) {
            ...
            try {
                ...
                recviewimg.setLayoutManager(new GridLayoutManager(ChallengeEditActivity.this, 3));
                ChallengeImageAdapter challengeImageAdapter = new ChallengeImageAdapter(imagearrbitmap, ChallengeEditActivity.this);
