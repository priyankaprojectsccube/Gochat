...
public class CharityEditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recviewimg.setLayoutManager(new GridLayoutManager(CharityEditActivity.this, 3));
        challengeImageAdapter = new ChallengeImageAdapter(imagearrbitmap, CharityEditActivity.this);
        ...
        if (getIntent().hasExtra("challengedetails")) {
            ...
            for (int i = 0; i < checkarraysize; i++) {
                ...
                new CharityEditActivity.MyAsyncTask().execute(imageurl);
...
//                }
            ...
            associationwebsite_textInputLayout.setText(pojo.getWebsitelink());
            donateto_textInputLayout.setText(pojo.getAssociationname());
            detailassociation_textInputLayout.setText(pojo.getDetailofassociation());
            bankdetailassociation_edittext.setText(pojo.getIban());
            swiftcode.setText(pojo.getSwiftcode());
...
//                recviewimg.getAdapter().notifyDataSetChanged();
        ...
        postChallengeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!validation.edttxtvalidation(challengeName_textInputLayout, CharityEditActivity.this)) {

                } else if (!validation.edttxtvalidation(challengeDesc_textInputLayout, CharityEditActivity.this)) {

                } else if (!validation.edttxtvalidation(challengeLocation_textInputLayout, CharityEditActivity.this)) {

                } else if (!validation.edttxtvalidation(challengeDate_textInputLayout, CharityEditActivity.this)) {

                } else if (imagearrbitmap.size()  < 2) {
                    //imagearr
                    Toast.makeText(CharityEditActivity.this, "Please select atleast two images", Toast.LENGTH_SHORT).show();
                }
                    ...
                    VolleyMultipartRequest volleyMultipartRequest = new VolleyMultipartRequest(Request.Method.POST, WebUrl.Update_challenge,
                                ...
                                public void onResponse(NetworkResponse response) {
                                    ...
                                    try {
                                        ...
                                        if (jsonObject.getString("status").equals("1")) {
                                          //  finish();
                                            Intent intent=new Intent(CharityEditActivity.this, ChallangeaddedbymeActivity.class);
                                            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
                                            startActivity(intent);
                                        }
                                        Toast.makeText(CharityEditActivity.this, jsonObject.getString("message"), Toast.LENGTH_SHORT).show();
                        ...
                        public void onErrorResponse(VolleyError volleyError) {
                            ...
                            if (message != null) {
                                ...
                                Toast.makeText(CharityEditActivity.this, message, Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(CharityEditActivity.this, getResources().getString(R.string.anerroroccured), Toast.LENGTH_SHORT).show();
                        ...
                        protected Map<String, String> getParams() throws AuthFailureError {
                            ...
                            param.put("user_id", PrefManager.getUserId(CharityEditActivity.this));
                            param.put("challenge_type", "2");  //typeforcharity
                    ...
                    MySingleton.getInstance(CharityEditActivity.this).addToRequestQueue(volleyMultipartRequest);
                }
        ...
        challengeLocation_textInputLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Autocomplete.IntentBuilder(
                        ...
                        .build(CharityEditActivity.this);
        ...
        addpicture.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(CharityEditActivity.this, WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {

                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                        if (validation.neverAskAgainSelected(CharityEditActivity.this, WRITE_EXTERNAL_STORAGE, "STORAGE")) {
                            validation.displayNeverAskAgainDialog("storage", CharityEditActivity.this);
                        } else {
                            ActivityCompat.requestPermissions(CharityEditActivity.this,
        ...
        challengeDate_textInputLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dp = new DatePickerDialog(CharityEditActivity.this, android.R.style.Theme_Holo_Light_Dialog, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {


                        TimePickerDialog tp = new TimePickerDialog(CharityEditActivity.this, android.R.style.Theme_Holo_Light_Dialog, new TimePickerDialog.OnTimeSetListener() {
    ...
    private void delimgfrmdb(String imgidstr, int position) {
        ...
        stringRequest.setRetryPolicy(new DefaultRetryPolicy(
                ...
                DefaultRetryPolicy.DEFAULT_MAX_RETRIES,
                DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        MySingleton.getInstance(CharityEditActivity.this).addToRequestQueue(stringRequest);
            ...
            case 2:
                ...
                if (PResult.length > 0 && PResult[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    if (takePictureIntent.resolveActivity(getPackageManager()) != null) {
                        ...
                        if (photoFile != null) {
                            Uri photoURI = FileProvider.getUriForFile(CharityEditActivity.this,
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_IMAGE_PICK && resultCode == RESULT_OK) {
            ...
            try {
                ...
                recviewimg.setLayoutManager(new GridLayoutManager(CharityEditActivity.this, 3));
                ChallengeImageAdapter challengeImageAdapter = new ChallengeImageAdapter(imagearrbitmap, CharityEditActivity.this);
