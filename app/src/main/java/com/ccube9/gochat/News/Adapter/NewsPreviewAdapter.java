...
public class NewsPreviewAdapter extends RecyclerView.Adapter<NewsPreviewAdapter.MyViewHolder> {
    ...
    public NewsPreviewAdapter(ArrayList<PreviewImageHelperClass> mArrListImg, List<PreviewImageDetails> previewImageDetailsList, NewsPreview newsPreview) {
        this.previewImageDetailsList = previewImageDetailsList;
        this.context = newsPreview;
    ...
    @NonNull
    @Override
    public NewsPreviewAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.selectimage_newspreview, parent, false);

        return new NewsPreviewAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final NewsPreviewAdapter.MyViewHolder holder, final int position) {
    ...
    private void calldelete(String get_id, int position) {
        ...
        pd.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, WebUrl.delete_preview_news, new Response.Listener<String>() {
            @SuppressLint("LongLogTag")
            @Override
            public void onResponse(String response) {
                pd.dismiss();
                Log.d("delete_preview_news_re", response);
