...
public class MyPotListAdapter  extends RecyclerView.Adapter<MyPotListAdapter.MyViewHolder> {
    ...
    public MyPotListAdapter(List<MYPOTLIST> mypotListArrayList, Context context) {
    ...
    @NonNull
    @Override
    public MyPotListAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.mypotslist_adapter, parent, false);

        return new MyPotListAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(final MyPotListAdapter.MyViewHolder holder, final int position) {
